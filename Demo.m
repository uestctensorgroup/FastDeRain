...
% MSSIM     ->	mean value of the structural similarity                  	Ref: Z. Wang, A. C. Bovik, H. R. Sheikh, and E. P. Simoncelli, “Image quality assessment: from error visibility to structural similarity,” IEEE Transactions on Image Processing, vol. 13, no. 4, pp. 600–612, 2004.
% MFSIM     ->	mean value of the feature similarity                        Ref: L. Zhang, L. Zhang, X. Mou, and D. Zhang, “Fsim: A feature similarity index for image quality assessment,” IEEE transactions on Image Processing, vol. 20, no. 8, pp. 2378–2386, 2011.
% MVIF      ->	mean value of the visual information fidelity               Ref: H. R. Sheikh and A. C. Bovik, “Image information and visual quality,”IEEE Transactions on image processing, vol. 15, no. 2, pp. 430–444, 2006
% MUIQI     ->	mean value of the universal image quality index             Ref: Z. Wang and A. C. Bovik, “A universal image quality index,” IEEE Signal Processing Letters, vol. 9, no. 3, pp. 81–84, 2002.
% MGMSD     ->	mean value of the gradient magnitude similarity deviation   Ref: W. Xue, L. Zhang, X. Mou, and A. C. Bovik, “Gradient magnitude similarity deviation: A highly efficient perceptual image quality index,” IEEE Transactions on Image Processing, vol. 23, no. 2, pp. 684–695, 2014.
